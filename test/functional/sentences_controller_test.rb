...
class SentencesControllerTest < ActionController::TestCase
  ...
  test "should create sentence" do
    assert_difference('Sentence.count') do
      post :create, sentence: { content: @sentence.content, type_id: @sentence.type_id, word_count: @sentence.word_count }
    end
  ...
  test "should update sentence" do
    put :update, id: @sentence, sentence: { content: @sentence.content, type_id: @sentence.type_id, word_count: @sentence.word_count }
    assert_redirected_to sentence_path(assigns(:sentence))
  end
